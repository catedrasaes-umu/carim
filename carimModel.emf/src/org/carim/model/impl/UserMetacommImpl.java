 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.UserMetacommImpl#isIsTimeOut <em>Is Time Out</em>}</li>
 *   <li>{@link org.carim.model.impl.UserMetacommImpl#isIsCancel <em>Is Cancel</em>}</li>
 *   <li>{@link org.carim.model.impl.UserMetacommImpl#isIsRestart <em>Is Restart</em>}</li>
 *   <li>{@link org.carim.model.impl.UserMetacommImpl#isIsBargein <em>Is Bargein</em>}</li>
 *   <li>{@link org.carim.model.impl.UserMetacommImpl#isIsSuccessfulBargein <em>Is Successful Bargein</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserMetacommImpl extends MetacommImpl implements UserMetacomm {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.USER_METACOMM;
	}
	...
	public void setIsTimeOut(boolean newIsTimeOut) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.USER_METACOMM__IS_TIME_OUT, oldIsTimeOut, isTimeOut, !oldIsTimeOutESet));
	}
	...
	public void unsetIsTimeOut() {
		...
		isTimeOutESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.USER_METACOMM__IS_TIME_OUT, oldIsTimeOut, IS_TIME_OUT_EDEFAULT, oldIsTimeOutESet));
	}
	...
	public void setIsCancel(boolean newIsCancel) {
		...
		isCancelESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.USER_METACOMM__IS_CANCEL, oldIsCancel, isCancel, !oldIsCancelESet));
	}
	...
	public void unsetIsCancel() {
		...
		isCancelESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.USER_METACOMM__IS_CANCEL, oldIsCancel, IS_CANCEL_EDEFAULT, oldIsCancelESet));
	}
	...
	public void setIsRestart(boolean newIsRestart) {
		...
		isRestartESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.USER_METACOMM__IS_RESTART, oldIsRestart, isRestart, !oldIsRestartESet));
	}
	...
	public void unsetIsRestart() {
		...
		isRestartESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.USER_METACOMM__IS_RESTART, oldIsRestart, IS_RESTART_EDEFAULT, oldIsRestartESet));
	}
	...
	public void setIsBargein(boolean newIsBargein) {
		...
		isBargeinESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.USER_METACOMM__IS_BARGEIN, oldIsBargein, isBargein, !oldIsBargeinESet));
	}
	...
	public void unsetIsBargein() {
		...
		isBargeinESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.USER_METACOMM__IS_BARGEIN, oldIsBargein, IS_BARGEIN_EDEFAULT, oldIsBargeinESet));
	}
	...
	public void setIsSuccessfulBargein(boolean newIsSuccessfulBargein) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.USER_METACOMM__IS_SUCCESSFUL_BARGEIN, oldIsSuccessfulBargein, isSuccessfulBargein, !oldIsSuccessfulBargeinESet));
	}
	...
	public void unsetIsSuccessfulBargein() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.USER_METACOMM__IS_SUCCESSFUL_BARGEIN, oldIsSuccessfulBargein, IS_SUCCESSFUL_BARGEIN_EDEFAULT, oldIsSuccessfulBargeinESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.USER_METACOMM__IS_TIME_OUT:
				return isIsTimeOut();
			case carimModelPackage.USER_METACOMM__IS_CANCEL:
				return isIsCancel();
			case carimModelPackage.USER_METACOMM__IS_RESTART:
				return isIsRestart();
			case carimModelPackage.USER_METACOMM__IS_BARGEIN:
				return isIsBargein();
			case carimModelPackage.USER_METACOMM__IS_SUCCESSFUL_BARGEIN:
