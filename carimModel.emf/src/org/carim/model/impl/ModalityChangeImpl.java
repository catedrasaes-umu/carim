 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.ModalityChangeImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link org.carim.model.impl.ModalityChangeImpl#getReason <em>Reason</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModalityChangeImpl extends EObjectImpl implements ModalityChange {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.MODALITY_CHANGE;
	}
	...
	public void setOrigin(RoleT newOrigin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.MODALITY_CHANGE__ORIGIN, oldOrigin, origin, !oldOriginESet));
	}
	...
	public void unsetOrigin() {
		...
		originESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.MODALITY_CHANGE__ORIGIN, oldOrigin, ORIGIN_EDEFAULT, oldOriginESet));
	}
	...
	public void setReason(McReasonT newReason) {
		...
		reasonESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.MODALITY_CHANGE__REASON, oldReason, reason, !oldReasonESet));
	}
	...
	public void unsetReason() {
		...
		reasonESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.MODALITY_CHANGE__REASON, oldReason, REASON_EDEFAULT, oldReasonESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.MODALITY_CHANGE__ORIGIN:
				return getOrigin();
			case carimModelPackage.MODALITY_CHANGE__REASON:
				return getReason();
		}
