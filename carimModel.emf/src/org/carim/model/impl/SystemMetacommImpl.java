 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.SystemMetacommImpl#isIsASRReject <em>Is ASR Reject</em>}</li>
 *   <li>{@link org.carim.model.impl.SystemMetacommImpl#isIsDIVReject <em>Is DIV Reject</em>}</li>
 *   <li>{@link org.carim.model.impl.SystemMetacommImpl#isIsGRReject <em>Is GR Reject</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SystemMetacommImpl extends MetacommImpl implements SystemMetacomm {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.SYSTEM_METACOMM;
	}
	...
	public void setIsASRReject(boolean newIsASRReject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SYSTEM_METACOMM__IS_ASR_REJECT, oldIsASRReject, isASRReject, !oldIsASRRejectESet));
	}
	...
	public void unsetIsASRReject() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SYSTEM_METACOMM__IS_ASR_REJECT, oldIsASRReject, IS_ASR_REJECT_EDEFAULT, oldIsASRRejectESet));
	}
	...
	public void setIsDIVReject(boolean newIsDIVReject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SYSTEM_METACOMM__IS_DIV_REJECT, oldIsDIVReject, isDIVReject, !oldIsDIVRejectESet));
	}
	...
	public void unsetIsDIVReject() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SYSTEM_METACOMM__IS_DIV_REJECT, oldIsDIVReject, IS_DIV_REJECT_EDEFAULT, oldIsDIVRejectESet));
	}
	...
	public void setIsGRReject(boolean newIsGRReject) {
		...
		isGRRejectESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SYSTEM_METACOMM__IS_GR_REJECT, oldIsGRReject, isGRReject, !oldIsGRRejectESet));
	}
	...
	public void unsetIsGRReject() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SYSTEM_METACOMM__IS_GR_REJECT, oldIsGRReject, IS_GR_REJECT_EDEFAULT, oldIsGRRejectESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.SYSTEM_METACOMM__IS_ASR_REJECT:
				return isIsASRReject();
			case carimModelPackage.SYSTEM_METACOMM__IS_DIV_REJECT:
				return isIsDIVReject();
			case carimModelPackage.SYSTEM_METACOMM__IS_GR_REJECT:
				return isIsGRReject();
		}
