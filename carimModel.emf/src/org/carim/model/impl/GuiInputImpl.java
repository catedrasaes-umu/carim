 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.GuiInputImpl#getTextElements <em>Text Elements</em>}</li>
 *   <li>{@link org.carim.model.impl.GuiInputImpl#getNavigationActions <em>Navigation Actions</em>}</li>
 *   <li>{@link org.carim.model.impl.GuiInputImpl#getNavigationMoves <em>Navigation Moves</em>}</li>
 *   <li>{@link org.carim.model.impl.GuiInputImpl#getNavigationLength <em>Navigation Length</em>}</li>
 *   <li>{@link org.carim.model.impl.GuiInputImpl#getExploringActions <em>Exploring Actions</em>}</li>
 *   <li>{@link org.carim.model.impl.GuiInputImpl#getTransferringActions <em>Transferring Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GuiInputImpl extends EObjectImpl implements GuiInput {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.GUI_INPUT;
	}
	...
	public void setTextElements(long newTextElements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.GUI_INPUT__TEXT_ELEMENTS, oldTextElements, textElements, !oldTextElementsESet));
	}
	...
	public void unsetTextElements() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.GUI_INPUT__TEXT_ELEMENTS, oldTextElements, TEXT_ELEMENTS_EDEFAULT, oldTextElementsESet));
	}
	...
	public void setNavigationActions(long newNavigationActions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.GUI_INPUT__NAVIGATION_ACTIONS, oldNavigationActions, navigationActions, !oldNavigationActionsESet));
	}
	...
	public void unsetNavigationActions() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.GUI_INPUT__NAVIGATION_ACTIONS, oldNavigationActions, NAVIGATION_ACTIONS_EDEFAULT, oldNavigationActionsESet));
	}
	...
	public void setNavigationMoves(long newNavigationMoves) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.GUI_INPUT__NAVIGATION_MOVES, oldNavigationMoves, navigationMoves, !oldNavigationMovesESet));
	}
	...
	public void unsetNavigationMoves() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.GUI_INPUT__NAVIGATION_MOVES, oldNavigationMoves, NAVIGATION_MOVES_EDEFAULT, oldNavigationMovesESet));
	}
	...
	public void setNavigationLength(long newNavigationLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.GUI_INPUT__NAVIGATION_LENGTH, oldNavigationLength, navigationLength, !oldNavigationLengthESet));
	}
	...
	public void unsetNavigationLength() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.GUI_INPUT__NAVIGATION_LENGTH, oldNavigationLength, NAVIGATION_LENGTH_EDEFAULT, oldNavigationLengthESet));
	}
	...
	public void setExploringActions(long newExploringActions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.GUI_INPUT__EXPLORING_ACTIONS, oldExploringActions, exploringActions, !oldExploringActionsESet));
	}
	...
	public void unsetExploringActions() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.GUI_INPUT__EXPLORING_ACTIONS, oldExploringActions, EXPLORING_ACTIONS_EDEFAULT, oldExploringActionsESet));
	}
	...
	public void setTransferringActions(long newTransferringActions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.GUI_INPUT__TRANSFERRING_ACTIONS, oldTransferringActions, transferringActions, !oldTransferringActionsESet));
	}
	...
	public void unsetTransferringActions() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.GUI_INPUT__TRANSFERRING_ACTIONS, oldTransferringActions, TRANSFERRING_ACTIONS_EDEFAULT, oldTransferringActionsESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.GUI_INPUT__TEXT_ELEMENTS:
				return getTextElements();
			case carimModelPackage.GUI_INPUT__NAVIGATION_ACTIONS:
				return getNavigationActions();
			case carimModelPackage.GUI_INPUT__NAVIGATION_MOVES:
				return getNavigationMoves();
			case carimModelPackage.GUI_INPUT__NAVIGATION_LENGTH:
				return getNavigationLength();
			case carimModelPackage.GUI_INPUT__EXPLORING_ACTIONS:
				return getExploringActions();
			case carimModelPackage.GUI_INPUT__TRANSFERRING_ACTIONS:
