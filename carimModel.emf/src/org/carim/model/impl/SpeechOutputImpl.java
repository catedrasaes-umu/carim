 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.SpeechOutputImpl#getANCO <em>ANCO</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechOutputImpl#getANIN <em>ANIN</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechOutputImpl#getANPA <em>ANPA</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechOutputImpl#getANFA <em>ANFA</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechOutputImpl#getPromptType <em>Prompt Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpeechOutputImpl extends EObjectImpl implements SpeechOutput {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.SPEECH_OUTPUT;
	}
	...
	public void setANCO(long newANCO) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_OUTPUT__ANCO, oldANCO, aNCO, !oldANCOESet));
	}
	...
	public void unsetANCO() {
		...
		aNCOESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_OUTPUT__ANCO, oldANCO, ANCO_EDEFAULT, oldANCOESet));
	}
	...
	public void setANIN(long newANIN) {
		...
		aNINESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_OUTPUT__ANIN, oldANIN, aNIN, !oldANINESet));
	}
	...
	public void unsetANIN() {
		...
		aNINESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_OUTPUT__ANIN, oldANIN, ANIN_EDEFAULT, oldANINESet));
	}
	...
	public void setANPA(long newANPA) {
		...
		aNPAESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_OUTPUT__ANPA, oldANPA, aNPA, !oldANPAESet));
	}
	...
	public void unsetANPA() {
		...
		aNPAESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_OUTPUT__ANPA, oldANPA, ANPA_EDEFAULT, oldANPAESet));
	}
	...
	public void setANFA(long newANFA) {
		...
		aNFAESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_OUTPUT__ANFA, oldANFA, aNFA, !oldANFAESet));
	}
	...
	public void unsetANFA() {
		...
		aNFAESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_OUTPUT__ANFA, oldANFA, ANFA_EDEFAULT, oldANFAESet));
	}
	...
	public void setPromptType(PromptTypeT newPromptType) {
		...
		promptTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_OUTPUT__PROMPT_TYPE, oldPromptType, promptType, !oldPromptTypeESet));
	}
	...
	public void unsetPromptType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_OUTPUT__PROMPT_TYPE, oldPromptType, PROMPT_TYPE_EDEFAULT, oldPromptTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.SPEECH_OUTPUT__ANCO:
				return getANCO();
			case carimModelPackage.SPEECH_OUTPUT__ANIN:
				return getANIN();
			case carimModelPackage.SPEECH_OUTPUT__ANPA:
				return getANPA();
			case carimModelPackage.SPEECH_OUTPUT__ANFA:
				return getANFA();
			case carimModelPackage.SPEECH_OUTPUT__PROMPT_TYPE:
