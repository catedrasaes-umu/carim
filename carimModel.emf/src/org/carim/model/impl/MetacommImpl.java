 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.MetacommImpl#isIsHelp <em>Is Help</em>}</li>
 *   <li>{@link org.carim.model.impl.MetacommImpl#isIsCorrection <em>Is Correction</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MetacommImpl extends EObjectImpl implements Metacomm {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.METACOMM;
	}
	...
	public void setIsHelp(boolean newIsHelp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.METACOMM__IS_HELP, oldIsHelp, isHelp, !oldIsHelpESet));
	}
	...
	public void unsetIsHelp() {
		...
		isHelpESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.METACOMM__IS_HELP, oldIsHelp, IS_HELP_EDEFAULT, oldIsHelpESet));
	}
	...
	public void setIsCorrection(boolean newIsCorrection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.METACOMM__IS_CORRECTION, oldIsCorrection, isCorrection, !oldIsCorrectionESet));
	}
	...
	public void unsetIsCorrection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.METACOMM__IS_CORRECTION, oldIsCorrection, IS_CORRECTION_EDEFAULT, oldIsCorrectionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.METACOMM__IS_HELP:
				return isIsHelp();
			case carimModelPackage.METACOMM__IS_CORRECTION:
