 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.CooperativityImpl#getContextualAppropriateness <em>Contextual Appropriateness</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CooperativityImpl extends EObjectImpl implements Cooperativity {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.COOPERATIVITY;
	}
	...
	public void setContextualAppropriateness(ContextualAppropriatenessT newContextualAppropriateness) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.COOPERATIVITY__CONTEXTUAL_APPROPRIATENESS, oldContextualAppropriateness, contextualAppropriateness, !oldContextualAppropriatenessESet));
	}
	...
	public void unsetContextualAppropriateness() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.COOPERATIVITY__CONTEXTUAL_APPROPRIATENESS, oldContextualAppropriateness, CONTEXTUAL_APPROPRIATENESS_EDEFAULT, oldContextualAppropriatenessESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.COOPERATIVITY__CONTEXTUAL_APPROPRIATENESS:
