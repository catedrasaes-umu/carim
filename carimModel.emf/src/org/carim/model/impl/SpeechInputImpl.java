 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getOverallWords <em>Overall Words</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getSubstitutedWords <em>Substituted Words</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getDeletedWords <em>Deleted Words</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getInsertedWords <em>Inserted Words</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getOverallSentences <em>Overall Sentences</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getSubstitutedSentences <em>Substituted Sentences</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getDeletedSentences <em>Deleted Sentences</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getInsertedSentences <em>Inserted Sentences</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getOverallConcepts <em>Overall Concepts</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getSubstitutedConcepts <em>Substituted Concepts</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getDeletedConcepts <em>Deleted Concepts</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getInsertedConcepts <em>Inserted Concepts</em>}</li>
 *   <li>{@link org.carim.model.impl.SpeechInputImpl#getParsingResult <em>Parsing Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpeechInputImpl extends EObjectImpl implements SpeechInput {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.SPEECH_INPUT;
	}
	...
	public void setOverallWords(long newOverallWords) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__OVERALL_WORDS, oldOverallWords, overallWords, !oldOverallWordsESet));
	}
	...
	public void unsetOverallWords() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__OVERALL_WORDS, oldOverallWords, OVERALL_WORDS_EDEFAULT, oldOverallWordsESet));
	}
	...
	public void setSubstitutedWords(long newSubstitutedWords) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__SUBSTITUTED_WORDS, oldSubstitutedWords, substitutedWords, !oldSubstitutedWordsESet));
	}
	...
	public void unsetSubstitutedWords() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__SUBSTITUTED_WORDS, oldSubstitutedWords, SUBSTITUTED_WORDS_EDEFAULT, oldSubstitutedWordsESet));
	}
	...
	public void setDeletedWords(long newDeletedWords) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__DELETED_WORDS, oldDeletedWords, deletedWords, !oldDeletedWordsESet));
	}
	...
	public void unsetDeletedWords() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__DELETED_WORDS, oldDeletedWords, DELETED_WORDS_EDEFAULT, oldDeletedWordsESet));
	}
	...
	public void setInsertedWords(long newInsertedWords) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__INSERTED_WORDS, oldInsertedWords, insertedWords, !oldInsertedWordsESet));
	}
	...
	public void unsetInsertedWords() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__INSERTED_WORDS, oldInsertedWords, INSERTED_WORDS_EDEFAULT, oldInsertedWordsESet));
	}
	...
	public void setOverallSentences(long newOverallSentences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__OVERALL_SENTENCES, oldOverallSentences, overallSentences, !oldOverallSentencesESet));
	}
	...
	public void unsetOverallSentences() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__OVERALL_SENTENCES, oldOverallSentences, OVERALL_SENTENCES_EDEFAULT, oldOverallSentencesESet));
	}
	...
	public void setSubstitutedSentences(long newSubstitutedSentences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__SUBSTITUTED_SENTENCES, oldSubstitutedSentences, substitutedSentences, !oldSubstitutedSentencesESet));
	}
	...
	public void unsetSubstitutedSentences() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__SUBSTITUTED_SENTENCES, oldSubstitutedSentences, SUBSTITUTED_SENTENCES_EDEFAULT, oldSubstitutedSentencesESet));
	}
	...
	public void setDeletedSentences(long newDeletedSentences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__DELETED_SENTENCES, oldDeletedSentences, deletedSentences, !oldDeletedSentencesESet));
	}
	...
	public void unsetDeletedSentences() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__DELETED_SENTENCES, oldDeletedSentences, DELETED_SENTENCES_EDEFAULT, oldDeletedSentencesESet));
	}
	...
	public void setInsertedSentences(long newInsertedSentences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__INSERTED_SENTENCES, oldInsertedSentences, insertedSentences, !oldInsertedSentencesESet));
	}
	...
	public void unsetInsertedSentences() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__INSERTED_SENTENCES, oldInsertedSentences, INSERTED_SENTENCES_EDEFAULT, oldInsertedSentencesESet));
	}
	...
	public void setOverallConcepts(long newOverallConcepts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__OVERALL_CONCEPTS, oldOverallConcepts, overallConcepts, !oldOverallConceptsESet));
	}
	...
	public void unsetOverallConcepts() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__OVERALL_CONCEPTS, oldOverallConcepts, OVERALL_CONCEPTS_EDEFAULT, oldOverallConceptsESet));
	}
	...
	public void setSubstitutedConcepts(long newSubstitutedConcepts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__SUBSTITUTED_CONCEPTS, oldSubstitutedConcepts, substitutedConcepts, !oldSubstitutedConceptsESet));
	}
	...
	public void unsetSubstitutedConcepts() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__SUBSTITUTED_CONCEPTS, oldSubstitutedConcepts, SUBSTITUTED_CONCEPTS_EDEFAULT, oldSubstitutedConceptsESet));
	}
	...
	public void setDeletedConcepts(long newDeletedConcepts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__DELETED_CONCEPTS, oldDeletedConcepts, deletedConcepts, !oldDeletedConceptsESet));
	}
	...
	public void unsetDeletedConcepts() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__DELETED_CONCEPTS, oldDeletedConcepts, DELETED_CONCEPTS_EDEFAULT, oldDeletedConceptsESet));
	}
	...
	public void setInsertedConcepts(long newInsertedConcepts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__INSERTED_CONCEPTS, oldInsertedConcepts, insertedConcepts, !oldInsertedConceptsESet));
	}
	...
	public void unsetInsertedConcepts() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__INSERTED_CONCEPTS, oldInsertedConcepts, INSERTED_CONCEPTS_EDEFAULT, oldInsertedConceptsESet));
	}
	...
	public void setParsingResult(ParsingResultT newParsingResult) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.SPEECH_INPUT__PARSING_RESULT, oldParsingResult, parsingResult, !oldParsingResultESet));
	}
	...
	public void unsetParsingResult() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.SPEECH_INPUT__PARSING_RESULT, oldParsingResult, PARSING_RESULT_EDEFAULT, oldParsingResultESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.SPEECH_INPUT__OVERALL_WORDS:
				return getOverallWords();
			case carimModelPackage.SPEECH_INPUT__SUBSTITUTED_WORDS:
				return getSubstitutedWords();
			case carimModelPackage.SPEECH_INPUT__DELETED_WORDS:
				return getDeletedWords();
			case carimModelPackage.SPEECH_INPUT__INSERTED_WORDS:
				return getInsertedWords();
			case carimModelPackage.SPEECH_INPUT__OVERALL_SENTENCES:
				return getOverallSentences();
			case carimModelPackage.SPEECH_INPUT__SUBSTITUTED_SENTENCES:
				return getSubstitutedSentences();
			case carimModelPackage.SPEECH_INPUT__DELETED_SENTENCES:
				return getDeletedSentences();
			case carimModelPackage.SPEECH_INPUT__INSERTED_SENTENCES:
				return getInsertedSentences();
			case carimModelPackage.SPEECH_INPUT__OVERALL_CONCEPTS:
				return getOverallConcepts();
			case carimModelPackage.SPEECH_INPUT__SUBSTITUTED_CONCEPTS:
				return getSubstitutedConcepts();
			case carimModelPackage.SPEECH_INPUT__DELETED_CONCEPTS:
				return getDeletedConcepts();
			case carimModelPackage.SPEECH_INPUT__INSERTED_CONCEPTS:
				return getInsertedConcepts();
			case carimModelPackage.SPEECH_INPUT__PARSING_RESULT:
