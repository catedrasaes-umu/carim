 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.ModalityAppropriatenessImpl#getAppropriateness <em>Appropriateness</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModalityAppropriatenessImpl extends EObjectImpl implements ModalityAppropriateness {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.MODALITY_APPROPRIATENESS;
	}
	...
	public void setAppropriateness(ModAppropT newAppropriateness) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.MODALITY_APPROPRIATENESS__APPROPRIATENESS, oldAppropriateness, appropriateness, !oldAppropriatenessESet));
	}
	...
	public void unsetAppropriateness() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.MODALITY_APPROPRIATENESS__APPROPRIATENESS, oldAppropriateness, APPROPRIATENESS_EDEFAULT, oldAppropriatenessESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.MODALITY_APPROPRIATENESS__APPROPRIATENESS:
