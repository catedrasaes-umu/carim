 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.TurnImpl#getFeedbackDelay <em>Feedback Delay</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getFeedbackDuration <em>Feedback Duration</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getActionDuration <em>Action Duration</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getFeedback <em>Feedback</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getConcepts <em>Concepts</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getNoise <em>Noise</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getQuestions <em>Questions</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getModality <em>Modality</em>}</li>
 *   <li>{@link org.carim.model.impl.TurnImpl#getContext <em>Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TurnImpl extends EObjectImpl implements Turn {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.TURN;
	}
	...
	public void setFeedbackDelay(long newFeedbackDelay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__FEEDBACK_DELAY, oldFeedbackDelay, feedbackDelay, !oldFeedbackDelayESet));
	}
	...
	public void unsetFeedbackDelay() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.TURN__FEEDBACK_DELAY, oldFeedbackDelay, FEEDBACK_DELAY_EDEFAULT, oldFeedbackDelayESet));
	}
	...
	public void setFeedbackDuration(long newFeedbackDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__FEEDBACK_DURATION, oldFeedbackDuration, feedbackDuration, !oldFeedbackDurationESet));
	}
	...
	public void unsetFeedbackDuration() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.TURN__FEEDBACK_DURATION, oldFeedbackDuration, FEEDBACK_DURATION_EDEFAULT, oldFeedbackDurationESet));
	}
	...
	public void setActionDuration(long newActionDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__ACTION_DURATION, oldActionDuration, actionDuration, !oldActionDurationESet));
	}
	...
	public void unsetActionDuration() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.TURN__ACTION_DURATION, oldActionDuration, ACTION_DURATION_EDEFAULT, oldActionDurationESet));
	}
	...
	public void setElements(long newElements) {
		...
		elementsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__ELEMENTS, oldElements, elements, !oldElementsESet));
	}
	...
	public void unsetElements() {
		...
		elementsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.TURN__ELEMENTS, oldElements, ELEMENTS_EDEFAULT, oldElementsESet));
	}
	...
	public void setFeedback(long newFeedback) {
		...
		feedbackESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__FEEDBACK, oldFeedback, feedback, !oldFeedbackESet));
	}
	...
	public void unsetFeedback() {
		...
		feedbackESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.TURN__FEEDBACK, oldFeedback, FEEDBACK_EDEFAULT, oldFeedbackESet));
	}
	...
	public void setConcepts(long newConcepts) {
		...
		conceptsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__CONCEPTS, oldConcepts, concepts, !oldConceptsESet));
	}
	...
	public void unsetConcepts() {
		...
		conceptsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.TURN__CONCEPTS, oldConcepts, CONCEPTS_EDEFAULT, oldConceptsESet));
	}
	...
	public void setNoise(long newNoise) {
		...
		noiseESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__NOISE, oldNoise, noise, !oldNoiseESet));
	}
	...
	public void unsetNoise() {
		...
		noiseESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.TURN__NOISE, oldNoise, NOISE_EDEFAULT, oldNoiseESet));
	}
	...
	public void setQuestions(long newQuestions) {
		...
		questionsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__QUESTIONS, oldQuestions, questions, !oldQuestionsESet));
	}
	...
	public void unsetQuestions() {
		...
		questionsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, carimModelPackage.TURN__QUESTIONS, oldQuestions, QUESTIONS_EDEFAULT, oldQuestionsESet));
	}
	...
	public NotificationChain basicSetModality(ModalityInfo newModality, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__MODALITY, oldModality, newModality);
	...
	public void setModality(ModalityInfo newModality) {
		if (newModality != modality) {
			...
			if (modality != null)
				msgs = ((InternalEObject)modality).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - carimModelPackage.TURN__MODALITY, null, msgs);
			if (newModality != null)
				msgs = ((InternalEObject)newModality).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - carimModelPackage.TURN__MODALITY, null, msgs);
			msgs = basicSetModality(newModality, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__MODALITY, newModality, newModality));
	}
	...
	public NotificationChain basicSetContext(DynamicContext newContext, NotificationChain msgs) {
		...
		context = newContext;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__CONTEXT, oldContext, newContext);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContext(DynamicContext newContext) {
		if (newContext != context) {
			NotificationChain msgs = null;
			if (context != null)
				msgs = ((InternalEObject)context).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - carimModelPackage.TURN__CONTEXT, null, msgs);
			if (newContext != null)
				msgs = ((InternalEObject)newContext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - carimModelPackage.TURN__CONTEXT, null, msgs);
			msgs = basicSetContext(newContext, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.TURN__CONTEXT, newContext, newContext));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case carimModelPackage.TURN__MODALITY:
				return basicSetModality(null, msgs);
			case carimModelPackage.TURN__CONTEXT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case carimModelPackage.TURN__FEEDBACK_DELAY:
				return getFeedbackDelay();
			case carimModelPackage.TURN__FEEDBACK_DURATION:
				return getFeedbackDuration();
			case carimModelPackage.TURN__ACTION_DURATION:
				return getActionDuration();
			case carimModelPackage.TURN__ELEMENTS:
				return getElements();
			case carimModelPackage.TURN__FEEDBACK:
				return getFeedback();
			case carimModelPackage.TURN__CONCEPTS:
				return getConcepts();
			case carimModelPackage.TURN__NOISE:
				return getNoise();
			case carimModelPackage.TURN__QUESTIONS:
				return getQuestions();
			case carimModelPackage.TURN__MODALITY:
				return getModality();
			case carimModelPackage.TURN__CONTEXT:
