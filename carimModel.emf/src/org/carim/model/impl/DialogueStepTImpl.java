 ...
 * <ul>
 *   <li>{@link org.carim.model.impl.DialogueStepTImpl#getSystemTurn <em>System Turn</em>}</li>
 *   <li>{@link org.carim.model.impl.DialogueStepTImpl#getUserTurn <em>User Turn</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DialogueStepTImpl extends EObjectImpl implements DialogueStepT {
	...
	protected EClass eStaticClass() {
		return carimModelPackage.Literals.DIALOGUE_STEP_T;
	}
	...
	public NotificationChain basicSetSystemTurn(SystemTurn newSystemTurn, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, carimModelPackage.DIALOGUE_STEP_T__SYSTEM_TURN, oldSystemTurn, newSystemTurn);
	...
	public void setSystemTurn(SystemTurn newSystemTurn) {
		if (newSystemTurn != systemTurn) {
			...
			if (systemTurn != null)
				msgs = ((InternalEObject)systemTurn).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - carimModelPackage.DIALOGUE_STEP_T__SYSTEM_TURN, null, msgs);
			if (newSystemTurn != null)
				msgs = ((InternalEObject)newSystemTurn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - carimModelPackage.DIALOGUE_STEP_T__SYSTEM_TURN, null, msgs);
			msgs = basicSetSystemTurn(newSystemTurn, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.DIALOGUE_STEP_T__SYSTEM_TURN, newSystemTurn, newSystemTurn));
	}
	...
	public NotificationChain basicSetUserTurn(UserTurn newUserTurn, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, carimModelPackage.DIALOGUE_STEP_T__USER_TURN, oldUserTurn, newUserTurn);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUserTurn(UserTurn newUserTurn) {
		if (newUserTurn != userTurn) {
			NotificationChain msgs = null;
			if (userTurn != null)
				msgs = ((InternalEObject)userTurn).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - carimModelPackage.DIALOGUE_STEP_T__USER_TURN, null, msgs);
			if (newUserTurn != null)
				msgs = ((InternalEObject)newUserTurn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - carimModelPackage.DIALOGUE_STEP_T__USER_TURN, null, msgs);
			msgs = basicSetUserTurn(newUserTurn, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, carimModelPackage.DIALOGUE_STEP_T__USER_TURN, newUserTurn, newUserTurn));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case carimModelPackage.DIALOGUE_STEP_T__SYSTEM_TURN:
				return basicSetSystemTurn(null, msgs);
			case carimModelPackage.DIALOGUE_STEP_T__USER_TURN:
