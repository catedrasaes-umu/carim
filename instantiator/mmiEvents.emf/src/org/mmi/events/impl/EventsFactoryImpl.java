...
public class EventsFactoryImpl extends EFactoryImpl implements EventsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case EventsPackage.WEATHER_UPDATE_EVENT: return createWeatherUpdateEvent();
			case EventsPackage.AMBIENT_UPDATE_EVENT: return createAmbientUpdateEvent();
			case EventsPackage.USER_DATA_UPDATE_EVENT: return createUserDataUpdateEvent();
			case EventsPackage.USER_RATINGS_UPDATE_EVENT: return createUserRatingsUpdateEvent();
			case EventsPackage.USER_ATTITUDE_UPDATE_EVENT: return createUserAttitudeUpdateEvent();
			case EventsPackage.USER_MOOD_UPDATE_EVENT: return createUserMoodUpdateEvent();
			case EventsPackage.SOCIAL_UPDATE_EVENT: return createSocialUpdateEvent();
			case EventsPackage.LOCATION_UPDATE_EVENT: return createLocationUpdateEvent();
			case EventsPackage.MOBILITY_UPDATE_EVENT: return createMobilityUpdateEvent();
			case EventsPackage.TIME_UPDATE_EVENT: return createTimeUpdateEvent();
			case EventsPackage.DEVICE_FEATURES_UPDATE_EVENT: return createDeviceFeaturesUpdateEvent();
			case EventsPackage.DEVICE_RUNNING_FEATURES_UPDATE_EVENT: return createDeviceRunningFeaturesUpdateEvent();
			case EventsPackage.DEVICE_WORKLOAD_UPDATE_EVENT: return createDeviceWorkloadUpdateEvent();
			case EventsPackage.SIGNAL_UPDATE_EVENT: return createSignalUpdateEvent();
			case EventsPackage.THROUGHPUT_UPDATE_EVENT: return createThroughputUpdateEvent();
			case EventsPackage.SERVER_RESPONSE_UPDATE_EVENT: return createServerResponseUpdateEvent();
			...
			case EventsPackage.TILT_EVENT: return createTiltEvent();
			case EventsPackage.TWIST_EVENT: return createTwistEvent();
			case EventsPackage.SHAKE_EVENT: return createShakeEvent();
			case EventsPackage.MOTION_ACTION_EVENT: return createMotionActionEvent();
	 ...
	 * @generated
	 */
	public WeatherUpdateEvent createWeatherUpdateEvent() {
		WeatherUpdateEventImpl weatherUpdateEvent = new WeatherUpdateEventImpl();
	 ...
	 * @generated
	 */
	public AmbientUpdateEvent createAmbientUpdateEvent() {
		AmbientUpdateEventImpl ambientUpdateEvent = new AmbientUpdateEventImpl();
		return ambientUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public UserDataUpdateEvent createUserDataUpdateEvent() {
		UserDataUpdateEventImpl userDataUpdateEvent = new UserDataUpdateEventImpl();
	 ...
	 * @generated
	 */
	public UserRatingsUpdateEvent createUserRatingsUpdateEvent() {
		UserRatingsUpdateEventImpl userRatingsUpdateEvent = new UserRatingsUpdateEventImpl();
		return userRatingsUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public UserAttitudeUpdateEvent createUserAttitudeUpdateEvent() {
		UserAttitudeUpdateEventImpl userAttitudeUpdateEvent = new UserAttitudeUpdateEventImpl();
		return userAttitudeUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public UserMoodUpdateEvent createUserMoodUpdateEvent() {
		UserMoodUpdateEventImpl userMoodUpdateEvent = new UserMoodUpdateEventImpl();
		return userMoodUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public SocialUpdateEvent createSocialUpdateEvent() {
		SocialUpdateEventImpl socialUpdateEvent = new SocialUpdateEventImpl();
		return socialUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public LocationUpdateEvent createLocationUpdateEvent() {
		LocationUpdateEventImpl locationUpdateEvent = new LocationUpdateEventImpl();
	 ...
	 * @generated
	 */
	public MobilityUpdateEvent createMobilityUpdateEvent() {
		MobilityUpdateEventImpl mobilityUpdateEvent = new MobilityUpdateEventImpl();
		return mobilityUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public TimeUpdateEvent createTimeUpdateEvent() {
		TimeUpdateEventImpl timeUpdateEvent = new TimeUpdateEventImpl();
	 ...
	 * @generated
	 */
	public DeviceFeaturesUpdateEvent createDeviceFeaturesUpdateEvent() {
		DeviceFeaturesUpdateEventImpl deviceFeaturesUpdateEvent = new DeviceFeaturesUpdateEventImpl();
		return deviceFeaturesUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public DeviceRunningFeaturesUpdateEvent createDeviceRunningFeaturesUpdateEvent() {
		DeviceRunningFeaturesUpdateEventImpl deviceRunningFeaturesUpdateEvent = new DeviceRunningFeaturesUpdateEventImpl();
		return deviceRunningFeaturesUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public DeviceWorkloadUpdateEvent createDeviceWorkloadUpdateEvent() {
		DeviceWorkloadUpdateEventImpl deviceWorkloadUpdateEvent = new DeviceWorkloadUpdateEventImpl();
		return deviceWorkloadUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public SignalUpdateEvent createSignalUpdateEvent() {
		SignalUpdateEventImpl signalUpdateEvent = new SignalUpdateEventImpl();
	 ...
	 * @generated
	 */
	public ThroughputUpdateEvent createThroughputUpdateEvent() {
		ThroughputUpdateEventImpl throughputUpdateEvent = new ThroughputUpdateEventImpl();
		return throughputUpdateEvent;
	}
	 ...
	 * @generated
	 */
	public ServerResponseUpdateEvent createServerResponseUpdateEvent() {
		ServerResponseUpdateEventImpl serverResponseUpdateEvent = new ServerResponseUpdateEventImpl();
		return serverResponseUpdateEvent;
	}
	...
	public TiltEvent createTiltEvent() {
		TiltEventImpl tiltEvent = new TiltEventImpl();
		return tiltEvent;
	}
	...
	public TwistEvent createTwistEvent() {
		TwistEventImpl twistEvent = new TwistEventImpl();
		return twistEvent;
	}
	...
	public MotionActionEvent createMotionActionEvent() {
		MotionActionEventImpl motionActionEvent = new MotionActionEventImpl();
		return motionActionEvent;
	}
