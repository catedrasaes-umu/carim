...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Inserted Concepts Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mmi.events.impl.InsertedConceptsEventImpl#getNconcepts <em>Nconcepts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InsertedConceptsEventImpl extends SpeechInputEventImpl implements InsertedConceptsEvent {
	/**
	 ...
	 * @generated
	 */
	protected InsertedConceptsEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventsPackage.Literals.INSERTED_CONCEPTS_EVENT;
	}
	...
	public void setNconcepts(int newNconcepts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.INSERTED_CONCEPTS_EVENT__NCONCEPTS, oldNconcepts, nconcepts));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventsPackage.INSERTED_CONCEPTS_EVENT__NCONCEPTS:
				return getNconcepts();
		}
