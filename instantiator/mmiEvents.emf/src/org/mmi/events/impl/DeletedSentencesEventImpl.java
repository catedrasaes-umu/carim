...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Deleted Sentences Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mmi.events.impl.DeletedSentencesEventImpl#getNsentences <em>Nsentences</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeletedSentencesEventImpl extends SpeechInputEventImpl implements DeletedSentencesEvent {
	/**
	 ...
	 * @generated
	 */
	protected DeletedSentencesEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventsPackage.Literals.DELETED_SENTENCES_EVENT;
	}
	...
	public void setNsentences(int newNsentences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.DELETED_SENTENCES_EVENT__NSENTENCES, oldNsentences, nsentences));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventsPackage.DELETED_SENTENCES_EVENT__NSENTENCES:
