...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Substituted Sentences Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mmi.events.impl.SubstitutedSentencesEventImpl#getNsentences <em>Nsentences</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubstitutedSentencesEventImpl extends SpeechInputEventImpl implements SubstitutedSentencesEvent {
	/**
	 ...
	 * @generated
	 */
	protected SubstitutedSentencesEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventsPackage.Literals.SUBSTITUTED_SENTENCES_EVENT;
	}
	...
	public void setNsentences(int newNsentences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.SUBSTITUTED_SENTENCES_EVENT__NSENTENCES, oldNsentences, nsentences));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventsPackage.SUBSTITUTED_SENTENCES_EVENT__NSENTENCES:
