...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Inserted Sentences Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mmi.events.impl.InsertedSentencesEventImpl#getNsentences <em>Nsentences</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InsertedSentencesEventImpl extends SpeechInputEventImpl implements InsertedSentencesEvent {
	/**
	 ...
	 * @generated
	 */
	protected InsertedSentencesEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventsPackage.Literals.INSERTED_SENTENCES_EVENT;
	}
	...
	public void setNsentences(int newNsentences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.INSERTED_SENTENCES_EVENT__NSENTENCES, oldNsentences, nsentences));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventsPackage.INSERTED_SENTENCES_EVENT__NSENTENCES:
