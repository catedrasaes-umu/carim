...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Deleted Concepts Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.mmi.events.impl.DeletedConceptsEventImpl#getNconcepts <em>Nconcepts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeletedConceptsEventImpl extends SpeechInputEventImpl implements DeletedConceptsEvent {
	/**
	 ...
	 * @generated
	 */
	protected DeletedConceptsEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EventsPackage.Literals.DELETED_CONCEPTS_EVENT;
	}
	...
	public void setNconcepts(int newNconcepts) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.DELETED_CONCEPTS_EVENT__NCONCEPTS, oldNconcepts, nconcepts));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventsPackage.DELETED_CONCEPTS_EVENT__NCONCEPTS:
				return getNconcepts();
		}
