...
public class MetacommInstantiator extends InstantiatorBase {
	...
	public void setIsHelpTurn(boolean isSystemTurn){
		if (isSystemTurn)
			icontext_.getCurrentSystemTurn().getMetacomm().setIsHelp(true);
		else
		{
			icontext_.getCurrentUserTurn().getMetacomm().setIsHelp(true);
		}
	}
	...
	public void setIsCorrectionTurn(boolean isSystemTurn){
		if (isSystemTurn)
			icontext_.getCurrentSystemTurn().getMetacomm().setIsCorrection(true);
		else
			icontext_.getCurrentUserTurn().getMetacomm().setIsCorrection(true);
	}
	...
	public void setIsASRRejection(boolean isSystemTurn) throws InstantiationException{
		if (!isSystemTurn)
			...
			icontext_.getCurrentSystemTurn().getMetacomm().setIsASRReject(true);
	}
	...
	public void setIsDIVRejection(boolean isSystemTurn) throws InstantiationException{
		if (!isSystemTurn)
			...
			icontext_.getCurrentSystemTurn().getMetacomm().setIsDIVReject(true);
	}
	...
	public void setIsGRRejection(boolean isSystemTurn) throws InstantiationException{
		if (!isSystemTurn)
			...
			icontext_.getCurrentSystemTurn().getMetacomm().setIsGRReject(true);
	}
	...
	public void setIsTimeout(boolean isUserTurn) throws InstantiationException{
		if (!isUserTurn)
			...
			icontext_.getCurrentUserTurn().getMetacomm().setIsTimeOut(true);
	}
	...
	public void setIsCancelTurn(boolean isUserTurn) throws InstantiationException{
		if (!isUserTurn)
			...
			icontext_.getCurrentUserTurn().getMetacomm().setIsCancel(true);
	}
	...
	public void setIsRestartTurn(boolean isUserTurn) throws InstantiationException{
		if (!isUserTurn)
			...
			icontext_.getCurrentUserTurn().getMetacomm().setIsRestart(true);
	}
	...
	public void setIsBargein(boolean isUserTurn, boolean success) throws InstantiationException{
		if (!isUserTurn)
			...
			icontext_.getCurrentUserTurn().getMetacomm().setIsBargein(true);
			icontext_.getCurrentUserTurn().getMetacomm().setIsSuccessfulBargein(success);
		}
	}
}
