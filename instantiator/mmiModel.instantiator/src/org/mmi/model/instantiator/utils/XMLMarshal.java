...
import org.carim.model.util.carimModelResourceFactoryImpl;

/**
 * This class provides the tools needed to dump a Trial object
 * to an XML file, and also to obtain Trial objects from XML model
 * instances.
 * 
...
public class XMLMarshal {
	 ...
	 * @param droot the document root containing the Trial object
	...
	public static void SaveModelToFile(DocumentRoot droot, String filename){
		...
		(Resource.Factory.Registry.DEFAULT_EXTENSION, 
				new carimModelResourceFactoryImpl());
		// Register the package to ensure it is available during loading.
		resourceSet.getPackageRegistry().put(carimModelPackage.eNS_URI,carimModelPackage.eINSTANCE);
	...
	/**
	 * Gets the DocumentRoot object (including the Trial object) from
	 * a XML file.
	...
	public static DocumentRoot GetModelFromFile(String filename){
		...
		(carimModelPackage.eNS_URI, 
				carimModelPackage.eINSTANCE);
		...
		/**
		 * get the Trial object from a Resource
		 */

		System.out.println("Extracting the Trial object...");
