...
public class NavigationTextMetricsListener extends UserTurnPushingListener {
	...
	public NavigationTextMetricsListener(EventPool epool, MmiEventsFactory efact,
	...
	public void doWork(Event e) {
		...
		LOG.debug(e.getTimestamp() + "\t   L1 :: NavigationTextMetricsL: Work done.");
	...
	public LinkedList<Integer> registerTypes() {
		...
		//add own events
		auxl.add(event_t.NAVIGATIONMOVE_VALUE);
		auxl.add(event_t.NAVIGATIONACTION_VALUE);
		auxl.add(event_t.NAVIGATIONEXPLORE_VALUE);
		auxl.add(event_t.TEXTWORD_VALUE);
		auxl.add(event_t.TEXTCOMMAND_VALUE);
		auxl.add(event_t.TEXTEXPLORE_VALUE);
