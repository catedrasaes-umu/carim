...
public class ExploringTransferringListener extends UserTurnPushingListener {
	...
	public ExploringTransferringListener(EventPool epool, MmiEventsFactory efact,
	...
	private void _initializeSets(){
		...
		exploringSet_.add(event_t.NAVIGATIONMOVE_VALUE);
		exploringSet_.add(event_t.NAVIGATIONEXPLORE_VALUE);
		exploringSet_.add(event_t.TEXTEXPLORE_VALUE);

		///
		/// transferring events
		///
		transferringSet_ = new HashSet<Integer>();
		transferringSet_.add(event_t.NAVIGATIONACTION_VALUE);
		transferringSet_.add(event_t.TEXTWORD_VALUE);
		transferringSet_.add(event_t.TEXTCOMMAND_VALUE);
	}
	...
	public void doWork(Event e) {
		...
		LOG.debug(e.getTimestamp() + "\t   L1 :: ExploringTransferringL: Work done.");
