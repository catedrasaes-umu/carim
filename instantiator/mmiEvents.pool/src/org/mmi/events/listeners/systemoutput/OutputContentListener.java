...
public class OutputContentListener extends EndTurnPushingListener {
	...
	public OutputContentListener(EventPool epool, MmiEventsFactory efact,
	...
	public void doWork(Event e) {
		...
		LOG.debug(e.getTimestamp() + "\t   L1 :: OutputContentL: Work done.");
	...
	public LinkedList<Integer> registerTypes() {
		...
		//add own events
		auxl.add(event_t.GUIELEMENTS_VALUE);
		auxl.add(event_t.GUIFEEDBACK_VALUE);
		auxl.add(event_t.GUICONCEPTS_VALUE);
		auxl.add(event_t.GUINOISE_VALUE);
		auxl.add(event_t.GUIQUESTIONS_VALUE);
		auxl.add(event_t.SPEECHELEMENTS_VALUE);
		auxl.add(event_t.SPEECHFEEDBACK_VALUE);
		auxl.add(event_t.SPEECHCONCEPTS_VALUE);
		auxl.add(event_t.SPEECHNOISE_VALUE);
		auxl.add(event_t.SPEECHQUESTIONS_VALUE);
