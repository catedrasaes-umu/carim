...
import org.pedromateo.umulandertest2.LunarView.LunarThread;
...
public class LunarLander extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		///
		/// set listeners for control buttons
		...
		findViewById(R.id.bLeft).setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				mLunarView.doLeft(event);
				return false;
			}
		});

		/// right
		findViewById(R.id.bRight).setOnTouchListener(new View.OnTouchListener() {

			@Override
			public boolean onTouch(View v, MotionEvent event) {
				mLunarView.doRight(event);
				return false;
			}
		});

		/// ignition
		findViewById(R.id.bIgnition).setOnTouchListener(new View.OnTouchListener() {

			@Override
			public boolean onTouch(View v, MotionEvent event) {
				mLunarView.doIgnition(event);
				return false;
			}
		});
		...
		/// left
		findViewById(R.id.bLeft).setBackgroundResource(R.drawable.left);
		/// right 
		findViewById(R.id.bRight).setBackgroundResource(R.drawable.right);
		/// ignition
		findViewById(R.id.bIgnition).setBackgroundResource(R.drawable.ignition);
